...
function AddMapServerModal({ show, onClose, viewer, setMapTilesLoaded, mapServersWithDiscoveryRef }: AddMapServerModalProps) {
    ...
    const handleSubmit = () => {
        ...
        mapServer.queryCapabilities().then((_capabilities) => {
            ...
            if (!tileService && !discoveryService) {
                alert("No valid tileserver or discovery service found in the provided URL.");
            }
        });
        onClose();
    };
